from backend.app.services.gsm_service import GSMModem
from backend.app.services.ussd_simple import USSDSimple
from backend.app.core.config import settings
from backend.app.db.models import USSDHistory
