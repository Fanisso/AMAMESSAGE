...
from backend.app.db.models import ForwardingRule, ForwardingRuleLog
from backend.app.api.schemas_forwarding import (
...
async def test_forwarding_rules(
    ...
    """
    try:
        from backend.app.db.models import SMS, SMSDirection, SMSStatus
