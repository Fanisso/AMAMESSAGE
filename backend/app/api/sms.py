...
from backend.app.db.models import SMS, SMSStatus, SMSDirection, SMSQueue, SMSCommand, SMSResponse, Contact, ContactGroup, ContactGroupMember
...
async def send_sms(
    ...
    try:
        ...
        from backend.app.services.forwarding_service import ForwardingRuleService
...
async def get_queue_status(db: Session = Depends(get_db)):
    ...
    try:
        from backend.app.services.queue_processor import queue_processor
